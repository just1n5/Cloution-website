...
const LEGAL_DOCS = {
  terms: '/legal_docs/terminos-servicio-cloution.pdf',
  privacy: '/legal_docs/Politica%20de%20privacidad.pdf',
  cookies: '/legal_docs/Politica%20de%20cookies.pdf',
  security: '/legal_docs/Pol%C3%ADtica%20de%20Seguridad%20de%20Cloution.pdf'
}
...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    legal: [
      { name: 'Términos de Servicio', href: LEGAL_DOCS.terms, type: 'pdf' },
      { name: 'Política de Privacidad', href: LEGAL_DOCS.privacy, type: 'pdf' },
      { name: 'Política de Cookies', href: LEGAL_DOCS.cookies, type: 'pdf' },
      { name: 'Política de Seguridad', href: LEGAL_DOCS.security, type: 'pdf' },
      { name: 'SLA', href: '#sla' },
    ],
  }
