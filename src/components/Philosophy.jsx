  ...
  const values = [
    {
      ...
      description: 'Cada línea de código, cada solución, nace de nuestra pasión por crear tecnología que marca la diferencia.',
    },
    {
      icon: Users,
      title: 'Colaboración Genuina',
      description: 'Tu éxito es nuestro éxito. Trabajamos codo a codo como verdaderos socios tecnológicos.',
    },
    {
      icon: Rocket,
      title: 'Velocidad con Excelencia',
      description: 'Entregamos rápido sin comprometer la calidad. Agilidad y perfección en cada proyecto.',
    },
    {
      icon: Award,
      title: 'Compromiso con Resultados',
      description: 'No descansamos hasta superar tus expectativas. Cada proyecto es una promesa cumplida.',
    },
    {
      icon: Star,
      title: 'Calidad Sin Compromisos',
      description: 'Standards internacionales y mejores prácticas en cada aspecto de nuestro trabajo.',
    },
    {
      icon: Target,
      title: 'Enfoque en el Cliente',
      description: 'Tus objetivos guían cada decisión. Tu visión es nuestra hoja de ruta.',
    },
  ]
          ...
          <svg className="absolute inset-0 w-full h-full opacity-20">
            <defs>
              <pattern id="network" width="100" height="100" patternUnits="userSpaceOnUse">
                ...
                <line x1="0" y1="50" x2="100" y2="50" stroke="rgba(139, 92, 246, 0.2)" strokeWidth="0.5">
                  <animate attributeName="opacity" values="0.2;0.8;0.2" dur="4s" repeatCount="indefinite" />
                </line>
                <line x1="50" y1="0" x2="50" y2="100" stroke="rgba(20, 184, 166, 0.2)" strokeWidth="0.5">
                  <animate attributeName="opacity" values="0.2;0.8;0.2" dur="4s" repeatCount="indefinite" />
                </line>
              </pattern>
            </defs>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            En Cloution, creemos que la tecnología debe ser más que código. 
            Es el puente hacia un futuro mejor para tu empresa.
          </p>
        </motion.div>
          ...
          <div className="relative p-8 lg:p-12 rounded-3xl glass-effect border border-white/10 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                "Democratizar el acceso a tecnología de vanguardia, empoderando a las empresas 
                latinoamericanas para competir y triunfar en el escenario global. Creemos que 
                cada negocio, sin importar su tamaño, merece las mejores herramientas digitales 
