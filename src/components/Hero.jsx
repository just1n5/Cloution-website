...
const Hero = () => {
  ...
  const rotatingValues = [
    { text: "Soluciones que escalan contigo", color: "from-blue-400 to-cyan-400" },
    { text: "Acompañamiento cercano y constante", color: "from-purple-400 to-pink-400" },
    { text: "Implementación ágil y eficiente", color: "from-green-400 to-teal-400" },
    { text: "Seguridad y confianza garantizada", color: "from-orange-400 to-red-400" }
  ]
    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <span className="text-white">Innovamos y construimos</span>
            <span className="block gradient-text mt-2">tu futuro digital</span>
          </motion.h1>
          ...
          >
            Somos una <span className="text-white font-medium">startup tecnológica</span> que 
            impulsa a las empresas con soluciones B2B basadas en{' '}
            <span className="text-blue-400">inteligencia artificial</span>,{' '}
            <span className="text-purple-400">automatización</span> y{' '}
            <span className="text-teal-400">desarrollo a medida</span>. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-4">
              ...
              <motion.button
                ...
                style={{
                  ...
                  borderImage: 'linear-gradient(135deg, #2563eb, #8b5cf6, #14b8a6) 1',
                }}
              >
